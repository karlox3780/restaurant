...
function AboutUsPage() {
    return (
        <div className='absolute flex flex-col h-fit min-h-full w-full p-[10px] items-center justify-center text-teal-200 animate-fade-down animate-duration-1000'>
            <img className="w-[300px] max-md:w-full" src={AboutImage} alt="Imagen del restaurante" />
            <p className="w-[500px] pt-[20px] text-justify max-md:w-full">
            ...
            <p className="w-[500px] text-justify max-md:w-full">
